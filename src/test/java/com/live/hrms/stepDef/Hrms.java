...
public class Hrms {
    ...
    public void open_browser() throws MalformedURLException {
        ...
        selectHotel = new SelectHotel(driver, this.scenario);
    }
    ...
    @Then("Verify the location {string} is displayed in select hotel page")
    public void verify_the_location_is_displayed_in_select_hotel_page( String expected) {

       String actual= selectHotel.getTextFromLocation();
        selectHotel.verify(expected,actual);
